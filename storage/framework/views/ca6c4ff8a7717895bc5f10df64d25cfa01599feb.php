                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#" data-toggle="dropdown" data-i18n="Extra Components"><i class="feather icon-box"></i>Extra Components</a>
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="active" data-menu=""><a class="dropdown-item" href="ex-component-chips.html" data-toggle="dropdown" data-i18n="Chips"><i class="feather icon-circle"></i>Chips</a>
                                    </li>
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <div class="chip mr-1">
                                            <div class="chip-body">
                                                <div class="avatar">
                                                    <img class="img-fluid" src="../../../app-assets/images/portrait/small/avatar-s-2.jpg" alt="generic img placeholder" height="20" width="20">
                                                </div>
...
</html><?php /**PATH C:\xampp\htdocs\dzautotrader\resources\views/ex-component-chips.blade.php ENDPATH**/ ?>