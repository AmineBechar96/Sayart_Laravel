...
<body
    ...
    <div class="app-content content">
        ...
        <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('selected-service')->html();
} elseif ($_instance->childHasBeenRendered('4sPvcGl')) {
    $componentId = $_instance->getRenderedChildComponentId('4sPvcGl');
    $componentTag = $_instance->getRenderedChildComponentTagName('4sPvcGl');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('4sPvcGl');
} else {
    $response = \Livewire\Livewire::mount('selected-service');
    $html = $response->html();
    $_instance->logRenderedChild('4sPvcGl', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</html><?php /**PATH C:\xampp\htdocs\dzautosql\resources\views/my-services.blade.php ENDPATH**/ ?>