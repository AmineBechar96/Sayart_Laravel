...
<body
    ...
    <div class="app-content content">
        ...
        <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('liked-service')->html();
} elseif ($_instance->childHasBeenRendered('xdp05UO')) {
    $componentId = $_instance->getRenderedChildComponentId('xdp05UO');
    $componentTag = $_instance->getRenderedChildComponentTagName('xdp05UO');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('xdp05UO');
} else {
    $response = \Livewire\Livewire::mount('liked-service');
    $html = $response->html();
    $_instance->logRenderedChild('xdp05UO', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</html><?php /**PATH C:\xampp\htdocs\dzautosql\resources\views/liked-services.blade.php ENDPATH**/ ?>