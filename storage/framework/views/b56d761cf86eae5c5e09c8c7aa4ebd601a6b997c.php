    ...
    <div class="navbar-header d-xl-block d-none">
        <ul class="nav navbar-nav flex-row">
            <li class="nav-item"><a class="navbar" href="../../../html/ltr/horizontal-menu-template/index.html">
                    <div class="brand-logo"><img src="../../../app-assets/images/logo/logo1.png" height="45" width="120"
                            alt=""></div>
                </a></li>
        </ul>
    </div>
        ...
        <div class="navbar-container content">
            <div class="navbar-collapse" id="navbar-mobile">
                ...
                <ul class="nav navbar-nav float-right">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('login')); ?>"><i class="feather icon-log-in"></i>
                    ...
                    <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link"
                            ...
                            <div class="user-nav d-sm-flex d-none"><span
                                    ...
                                    class="user-status"><?php if(!is_null(Auth::user()->email_verified_at)): ?>
                                    ...
                                    <?php endif; ?></span></div><span><img class="round"
                        ...
                        <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item"
                            ...
                            <form id="logout-formm" action="<?php echo e(route('logout')); ?>" method="POST" style="display: none;">
                                <?php echo csrf_field(); ?>
                            </form>
                        </div>
                    </li>
...
<!-- END: Header--><?php /**PATH C:\xampp\htdocs\dzautosql - Copie (3)\resources\views/layouts/header.blade.php ENDPATH**/ ?>