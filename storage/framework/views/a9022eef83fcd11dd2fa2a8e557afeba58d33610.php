...
} elseif ($_instance->childHasBeenRendered('yjwueKK')) {
    $componentId = $_instance->getRenderedChildComponentId('yjwueKK');
    $componentTag = $_instance->getRenderedChildComponentTagName('yjwueKK');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('yjwueKK');
} else {
    $response = \Livewire\Livewire::mount('selected-service');
    $html = $response->html();
    $_instance->logRenderedChild('yjwueKK', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</html><?php /**PATH D:\projet\dzautosql-3.0\resources\views/my-services.blade.php ENDPATH**/ ?>