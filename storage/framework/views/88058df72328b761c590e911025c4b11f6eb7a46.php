                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <?php endif; ?>
                                        <form class="form" method="post" action="<?php echo e(route('advanced.store')); ?>">
                                            <?php echo csrf_field(); ?>
                                            <div class="form-body">
    ...
    <script>
        $(document).ready(function() {
                $('select[name="brands"]').on('change', function() {
                    ...
                    if (BrandId) {
                        $.ajax({
                            url: "<?php echo e(URL::to('model_3')); ?>/" + BrandId,
                            type: "GET",
                            dataType: "json",
    ...
    <script>
        $(document).ready(function() {
                $('select[name="model"]').on('change', function() {
                    ...
                    if (ModelId) {
                        $.ajax({
                            url: "<?php echo e(URL::to('serie_2')); ?>/" + ModelId,
                            type: "GET",
                            dataType: "json",
                            success: function(data) {
                ...
                $.ajax({
                            url: "<?php echo e(URL::to('location')); ?>/" + ModelId,
                            type: "GET",
                            dataType: "json",
                            success: function(data) {
                ...
                $.ajax({
                            url: "<?php echo e(URL::to('tdi')); ?>/" + ModelId,
                            type: "GET",
                            dataType: "json",
                            success: function(data) {
...
</html><?php /**PATH C:\xampp\htdocs\dzautosql\resources\views/advanced.blade.php ENDPATH**/ ?>