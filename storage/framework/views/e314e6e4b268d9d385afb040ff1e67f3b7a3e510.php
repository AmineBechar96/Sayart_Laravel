...
<body class="horizontal-layout horizontal-menu 2-columns  navbar-floating footer-static  " data-open="hover"
    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            ...
            <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('news-section')->html();
} elseif ($_instance->childHasBeenRendered('NV18J3C')) {
    $componentId = $_instance->getRenderedChildComponentId('NV18J3C');
    $componentTag = $_instance->getRenderedChildComponentTagName('NV18J3C');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('NV18J3C');
} else {
    $response = \Livewire\Livewire::mount('news-section');
    $html = $response->html();
    $_instance->logRenderedChild('NV18J3C', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </section>
...
</html><?php /**PATH C:\xampp\htdocs\dzautosql\resources\views/news.blade.php ENDPATH**/ ?>