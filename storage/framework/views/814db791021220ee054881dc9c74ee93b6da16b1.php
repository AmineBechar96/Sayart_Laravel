...
} elseif ($_instance->childHasBeenRendered('e8jxKna')) {
    $componentId = $_instance->getRenderedChildComponentId('e8jxKna');
    $componentTag = $_instance->getRenderedChildComponentTagName('e8jxKna');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('e8jxKna');
} else {
    $response = \Livewire\Livewire::mount('transport-vehicule');
    $html = $response->html();
    $_instance->logRenderedChild('e8jxKna', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</html><?php /**PATH D:\projet\dzautosql-3.0\resources\views/transport-operators.blade.php ENDPATH**/ ?>