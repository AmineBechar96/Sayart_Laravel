...
<body
    ...
    <div class="app-content content">
        ...
        <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('transport-vehicule')->html();
} elseif ($_instance->childHasBeenRendered('dhLiuaD')) {
    $componentId = $_instance->getRenderedChildComponentId('dhLiuaD');
    $componentTag = $_instance->getRenderedChildComponentTagName('dhLiuaD');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('dhLiuaD');
} else {
    $response = \Livewire\Livewire::mount('transport-vehicule');
    $html = $response->html();
    $_instance->logRenderedChild('dhLiuaD', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</html><?php /**PATH C:\xampp\htdocs\dzautosql\resources\views/transport-operators.blade.php ENDPATH**/ ?>