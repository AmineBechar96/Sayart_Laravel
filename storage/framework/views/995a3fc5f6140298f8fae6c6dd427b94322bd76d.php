                                                                        ...
                                                                        <div class="table-responsive">
                                                                            <table
                                                                                ...
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        <th scope="row"><?php echo e($market->id); ?>

                                                                                        </th>
                                                                                        <td><?php echo e($market->nom); ?></td>
                                                                                        <td><?php echo e($market->wilaya); ?></td>
                                                                                        <td style="color:#21de41">
                                                                                            <?php echo e($market->horaire); ?></td>
                                                                                        <td class="place text-center">
                                                                                            <a href=""
                                                                                                class="cursor-pointer"
                                                                                                data-toggle="modal"
                                                                                                data-target="#defaultSize"
                                                                                                data-location="<?php echo e($market->wilaya); ?>"
                                                                                                data-lat="<?php echo e($market->latitude); ?>"
                                                                                                data-long="<?php echo e($market->longitude); ?>"><i
                                                                                        ...
                                                                                        <td class="text-center"><a
                                                                                                ...
                                                                                                data-toggle="modal"
                                                                                                data-target="#large"
                                                                                                data-nom="<?php echo e($market->nom); ?>"
                                                                                                data-lat="<?php echo e($market->latitude); ?>"
                                                                                                data-long="<?php echo e($market->longitude); ?>"><i
...
</html><?php /**PATH C:\xampp\htdocs\dzautosql\resources\views/additional-features.blade.php ENDPATH**/ ?>