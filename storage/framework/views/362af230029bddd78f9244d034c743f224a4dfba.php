...
} elseif ($_instance->childHasBeenRendered('WGeikJo')) {
    $componentId = $_instance->getRenderedChildComponentId('WGeikJo');
    $componentTag = $_instance->getRenderedChildComponentTagName('WGeikJo');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('WGeikJo');
} else {
    $response = \Livewire\Livewire::mount('sell-point');
    $html = $response->html();
    $_instance->logRenderedChild('WGeikJo', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</html><?php /**PATH D:\projet\dzautosql-3.0\resources\views/sell-points.blade.php ENDPATH**/ ?>