...
} elseif ($_instance->childHasBeenRendered('PNv8K1a')) {
    $componentId = $_instance->getRenderedChildComponentId('PNv8K1a');
    $componentTag = $_instance->getRenderedChildComponentTagName('PNv8K1a');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('PNv8K1a');
} else {
    $response = \Livewire\Livewire::mount('counter');
    $html = $response->html();
    $_instance->logRenderedChild('PNv8K1a', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</html><?php /**PATH C:\xampp\htdocs\dzautosql\resources\views/rent-agencies.blade.php ENDPATH**/ ?>