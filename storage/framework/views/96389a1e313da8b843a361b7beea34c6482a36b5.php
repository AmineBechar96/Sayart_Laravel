...
<body
    ...
    <div class="app-content content">
        ...
        <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('sell-point')->html();
} elseif ($_instance->childHasBeenRendered('x2VSCgV')) {
    $componentId = $_instance->getRenderedChildComponentId('x2VSCgV');
    $componentTag = $_instance->getRenderedChildComponentTagName('x2VSCgV');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('x2VSCgV');
} else {
    $response = \Livewire\Livewire::mount('sell-point');
    $html = $response->html();
    $_instance->logRenderedChild('x2VSCgV', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</html><?php /**PATH C:\xampp\htdocs\dzautosql\resources\views/sell-points.blade.php ENDPATH**/ ?>