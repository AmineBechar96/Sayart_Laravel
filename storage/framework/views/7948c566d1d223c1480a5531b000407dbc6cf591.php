            ...
            <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
                <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="home"
                    ...
                    <ul class="dropdown-menu">
                        <?php if(Auth::user() and Auth::user()->hasVerifiedEmail()): ?>
...
<!-- END: Main Menu--><?php /**PATH C:\xampp\htdocs\dzautosql\resources\views/layouts/horizontal-menu-features.blade.php ENDPATH**/ ?>