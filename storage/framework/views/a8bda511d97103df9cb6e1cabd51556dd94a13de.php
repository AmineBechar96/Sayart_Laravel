                    ...
                    <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown"><i class="feather icon-layers"></i><span data-i18n="UI Elements">UI Elements</span></a>
                        <ul class="dropdown-menu">
                            ...
                            <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#" data-toggle="dropdown" data-i18n="Cards"><i class="feather icon-credit-card"></i>Cards</a>
                                <ul class="dropdown-menu">
                                    <li class="active" data-menu=""><a class="dropdown-item" href="card-basic.html" data-toggle="dropdown" data-i18n="Basic"><i class="feather icon-circle"></i>Basic</a>
                                    </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="card border-info text-center bg-transparent">
                                <div class="card-content">
                                    <img src="../../../app-assets/images/elements/macbook-pro.png" alt="element 04" width="200" class="float-left mt-3 pl-2">
                                    <div class="card-body">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="card text-white bg-gradient-danger text-center">
                                <div class="card-content d-flex">
                                    <div class="card-body">
                                        <img src="../../../app-assets/images/elements/iphone-x.png" alt="element 03" width="150" height="150" class="float-right px-1">
                                        <h4 class="card-title text-white mt-3">Brand Minute</h4>
                                        <p class="card-text">Donut toffee candy brownie.</p>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="card border-warning text-center bg-transparent">
                                <div class="card-content">
                                    <div class="card-body">
                                        <img src="../../../app-assets/images/elements/magic-mouse.png" alt="element 05" width="100" class="mb-1">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="card text-white bg-gradient-success text-center">
                                <div class="card-content">
                                    <div class="card-body">
                                        <img src="../../../app-assets/images/elements/beats-headphones.png" alt="element 02" width="150" class="mb-1">
                            ...
                            <div class="card-columns">
                                ...
                                <div class="card">
                                    <div class="card-content">
                                        ...
                                        <img class="card-img-bottom img-fluid" src="../../../app-assets/images/slider/01.jpg" alt="Card image cap">
                                    </div>
                                </div>
                                <div class="card text-white">
                                    <div class="card-content">
                                        <img class="card-img img-fluid" src="../../../app-assets/images/slider/03.jpg" alt="Card image">
                                ...
                                <div class="card border-info text-center bg-transparent">
                                    <div class="card-content">
                                        <img src="../../../app-assets/images/elements/macbook-pro.png" alt="element 04" width="150" class="float-left mt-3 pl-2 img-fluid">
                                        <div class="card-body">
                                            <h4 class="card-title mt-3">New Arrival</h4>
...
</html><?php /**PATH C:\xampp\htdocs\dzautotrader\resources\views/card-basic.blade.php ENDPATH**/ ?>