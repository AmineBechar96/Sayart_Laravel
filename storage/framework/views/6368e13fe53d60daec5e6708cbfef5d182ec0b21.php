...
<head>
    ...
    <title>Pills - Vuexy - Bootstrap HTML admin template</title>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#" data-toggle="dropdown" data-i18n="Components"><i class="feather icon-briefcase"></i>Components</a>
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="active" data-menu=""><a class="dropdown-item" href="component-pills-component.html" data-toggle="dropdown" data-i18n="Pills Component"><i class="feather icon-circle"></i>Pills Component</a>
                                    </li>
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Pills</h2>
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <ul class="nav nav-pills nav-fill">
                                            <li class="nav-item">
                                                <a class="nav-link" id="home-tab-fill" data-toggle="pill" href="#home-fill" aria-expanded="true">Home</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link active" id="profile-tab-fill" data-toggle="pill" href="#profile-fill" aria-expanded="false">Profile</a>
                                            </li>
                                            <li class="nav-item">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" id="about-tab-fill" data-toggle="pill" href="#about-fill" aria-expanded="false">About</a>
                                            </li>
                                        </ul>
                                        <div class="tab-content">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <ul class="nav nav-pills nav-justified">
                                            <li class="nav-item">
                                                <a class="nav-link" id="home-tab-justified" data-toggle="pill" href="#home-justified" aria-expanded="true">Home</a>
                                            </li>
                                            <li class="nav-item">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <ul class="nav nav-pills justify-content-center">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" id="about-tab-center" data-toggle="pill" href="#about-center" aria-expanded="false">About</a>
                                            </li>
                                        </ul>
                                        <div class="tab-content">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <ul class="nav nav-pills justify-content-end">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link active" id="profile-tab-end" data-toggle="pill" href="#profile-end" aria-expanded="false">Profile</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link disabled" href="#">
                                                    Disabled
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" id="about-tab-end" data-toggle="pill" href="#about-end" aria-expanded="false">About</a>
                                            </li>
                                        </ul>
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane active" id="profile-end" role="tabpanel" aria-labelledby="profile-tab-end" aria-expanded="false">
                                                <p>Pudding candy canes sugar plum cookie chocolate cake powder croissant. Carrot cake tiramisu danish
                                                    candy cake muffin croissant tart dessert. Tiramisu caramels candy canes chocolate cake sweet roll
                                                    liquorice icing cupcake.</p>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-10 col-sm-12">
                                                <div class="tab-content">
                                                    <div role="tabpanel" class="tab-pane" id="vertical-pill-1" aria-labelledby="stacked-pill-1" aria-expanded="true">
                                                        <p>Candy canes donut chupa chups candy canes lemon drops oat cake wafer. Cotton candy candy canes
                                                            marzipan carrot cake. Sesame snaps lemon drops candy marzipan donut brownie tootsie roll. Icing
                                                            croissant bonbon biscuit gummi bears.</p>
                                                        <p>
                                                    ...
                                                    <div class="tab-pane active" id="vertical-pill-2" role="tabpanel" aria-labelledby="stacked-pill-2" aria-expanded="false">
...
</html><?php /**PATH C:\xampp\htdocs\dzautosql\resources\views/component-pills-component.blade.php ENDPATH**/ ?>