                ...
                <div class="card ecommerce-card">
                    <div class="card-content" id="prod1">
                        <div class="item-img text-center">
                            <a href="<?php echo e($agency->type); ?>/agency-details/<?php echo e($agency->agency_ID); ?>">
                                <?php if($agency->type=="recovery-truck"): ?>
                                <a href="<?php echo e($agency->type); ?>/agency-details/<?php echo e($agency->agency_ID); ?>">
                                ...
                                <a href="<?php echo e($agency->type); ?>/agency-details/<?php echo e($agency->agency_ID); ?>">
                                    <img class="img-fluid" src="../../../app-assets/images/pages/depannage/piece.jpg"
                                        alt="img-placeholder"></a>
                                <?php elseif($agency->type=="rent-agency"): ?>
                                <a href="<?php echo e($agency->type); ?>/agency-details/<?php echo e($agency->agency_ID); ?>">
                                    <img class="img-fluid" src="../../../app-assets/images/pages/location/44.jpg"
                                        alt="img-placeholder"></a>
                                <?php elseif($agency->type=="sell-points"): ?>
                                <?php if(!is_null($agency->Maison)): ?>
                                <a href="<?php echo e($agency->type); ?>/agency-details/<?php echo e($agency->agency_ID); ?>">
                                    <img class="img-fluid" style="margin-top:66px;margin-bottom:67px;"
                                        src="../../../app-assets/images/brands/<?php echo e(strtolower($agency->Maison)); ?>.png"
                                        alt="img-placeholder"></a>
                                <?php else: ?>
                                <a href="<?php echo e($agency->type); ?>/agency-details/<?php echo e($agency->agency_ID); ?>"> <img
                        ...
                        <div class="item-options text-center">
                            ...
                            <div class="wishlistt" wire:click="dislike(<?php echo e($agency->agency_ID); ?>,'<?php echo e($agency->type); ?>')">
                            ...
                            <div class="cart">
                                ...
                                <span class="add-to-cart"
                                    wire:click="store(<?php echo e($agency->agency_ID); ?>,'<?php echo e($agency->type); ?>')">Enregistrer
                                </span>
                    ...
                    <div class="card-body">
                        ...
                        <div id="ratings">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="stars-received"><?php if(isset($data['data'][0])): ?>
                                    (<?php echo e($data['data'][0]); ?>)
                                    <?php endif; ?></div>
                            </div>
                            <div class="d-flex justify-content-between">
                                <ul class="unstyled-list list-inline ratings-list mb-0">
                                ...
                                <div class="stars-received"><?php if(isset($data['data'][1])): ?>
                                    (<?php echo e($data['data'][1]); ?>)
                                    <?php endif; ?></div>
                            </div>
                            <div class="d-flex justify-content-between">
                                <ul class="unstyled-list list-inline ratings-list mb-0">
                                ...
                                <div class="stars-received"><?php if(isset($data['data'][2])): ?>
                                    (<?php echo e($data['data'][2]); ?>)
                                    <?php endif; ?></div>
                            </div>
                            <div class="d-flex justify-content-between">
                                <ul class="unstyled-list list-inline ratings-list mb-0 ">
                                ...
                                <div class="stars-received"><?php if(isset($data['data'][3])): ?>
                                    (<?php echo e($data['data'][3]); ?>)
                                    <?php endif; ?></div>
                            </div>
                        </div>
                        <!-- Rating section Ends -->
...
<script>
    $(document).ready(function () {
         $('#filter').on('change', function (e) {
                            ...
                            window.livewire.find('<?php echo e($_instance->id); ?>').set('filter', data);
...
var type=null;
    $('.wishlisttt').on('click', function (e) {
            ...
            console.log(id);  
            console.log(type);  
            window.livewire.find('<?php echo e($_instance->id); ?>').set('likeed',true);
    ...
    /*  function addRow(ele) 
      ...
      /*  }
            ...
            var typee= $(ele).data('type');
                ...
                console.log(id);  
            console.log(type);
            window.livewire.find('<?php echo e($_instance->id); ?>').set('likeed',false );
            window.livewire.find('<?php echo e($_instance->id); ?>').set('agencyLikedId',idd);
            window.livewire.find('<?php echo e($_instance->id); ?>').set('agencyLikedType',typee);
            }
        }*/
</script>
<?php $__env->stopPush(); ?><?php /**PATH C:\xampp\htdocs\dzautosql\resources\views/livewire/liked-service.blade.php ENDPATH**/ ?>