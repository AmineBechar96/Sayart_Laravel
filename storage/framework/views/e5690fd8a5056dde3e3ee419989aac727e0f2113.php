                ...
                <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
                    ...
                    <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#"
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="active" data-menu=""><a class="dropdown-item" href="maps-google.html"
                                    data-toggle="dropdown" data-i18n="Google Maps"><i
                                        class="feather icon-map"></i>Google Maps</a>
                            </li>
                        </ul>
                    </li>
                    <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#"
                                    ...
                                    <div class="card-body">
                                        <div class="tab-content">
                                            <div role="tabpanel" class="tab-pane active" id="account-vertical-general"
                                                                    ...
                                                                    <p>La liste de tous les marchés locaux hebdomadaires
                                                                        ...
                                                                        <div class="table-responsive">
                                                                            <table
                                                                                ...
                                                                                <thead
                                                                                    style="background:#1CA7EC; color:white;">
                                                                                    <tr>
                                                                                        <th>ID</th>
                                                                                        <th>Nom </th>
                                                                                        <th>Wilaya</th>
                                                                                ...
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        <th scope="row">4</th>
                                                                                        <td>Chelghoum Laïd</td>
                                                                                        <td>Mila</td>
                                                                                        <td style="color:#21de41;">Sauf
                                                                                            le
                                                                                            vendredi</td>
                                                                                    </tr>
                                                                                    <tr>
                                                ...
                                                <div class="tab-pane fade" id="account-vertical-allocation"
                                                    role="tabpanel" aria-labelledby="account-pill-allocation"
                                                    aria-expanded="false">
                                                    <div class="row" id="table-head">
                                                        <div class="col-12">
                                                            <!-- gmaps Examples section start -->
                                                ...
                                                <div class="tab-pane fade" id="account-vertical-truck" role="tabpanel"
                                                    aria-labelledby="account-pill-truck" aria-expanded="false">
                                                    <div class="row" id="table-head">
                                                        <div class="col-12">
                                                            <!-- gmaps Examples section start -->
                                                            <section id="gmaps-basic-maps"
...
</html><?php /**PATH C:\xampp\htdocs\dzautosql\resources\views/popular-market.blade.php ENDPATH**/ ?>