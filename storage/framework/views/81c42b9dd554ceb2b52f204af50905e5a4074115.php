...
<body
    ...
    <div class="app-content content">
        ...
        <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('general-mech')->html();
} elseif ($_instance->childHasBeenRendered('7tdXBgh')) {
    $componentId = $_instance->getRenderedChildComponentId('7tdXBgh');
    $componentTag = $_instance->getRenderedChildComponentTagName('7tdXBgh');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('7tdXBgh');
} else {
    $response = \Livewire\Livewire::mount('general-mech');
    $html = $response->html();
    $_instance->logRenderedChild('7tdXBgh', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</html><?php /**PATH C:\xampp\htdocs\dzautosql\resources\views/general-mechanic.blade.php ENDPATH**/ ?>