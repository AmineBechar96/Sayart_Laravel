                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table">
                      <thead>
                        <tr>
                          <th><?php echo e($datatable['models'][0]); ?></th>
                          <th><?php echo e($datatable['models'][1]); ?></th>
                          <th><?php echo e($datatable['models'][2]); ?></th>
                          <th><?php echo e($datatable['models'][3]); ?></th>
                          <th><?php echo e($datatable['models'][4]); ?></th>
                          <th><?php echo e($datatable['models'][5]); ?></th>
                        </tr>
                      </thead>
                      <tbody>
                        <?php 
                                                ...
                                                ?>
                        <tr>
                          <td><?php echo e($mod1['brand'][$i]." ".$mod1['note'][$i]); ?></td>
                          <td><?php echo e($mod2['brand'][$i]." ".$mod2['note'][$i]); ?></td>
                          <td><?php echo e($mod3['brand'][$i]." ".$mod3['note'][$i]); ?></td>
                          <td><?php echo e($mod4['brand'][$i]." ".$mod4['note'][$i]); ?></td>
                          <td><?php echo e($mod5['brand'][$i]." ".$mod5['note'][$i]); ?></td>
                          <td><?php echo e($mod6['brand'][$i]." ".$mod6['note'][$i]); ?></td>
                        </tr>
                        <?php } ?>
                      </tbody>
                    </table>
...
</html><?php /**PATH C:\xampp\htdocs\dzautosql\resources\views/best.blade.php ENDPATH**/ ?>