                                        ...
                                        <div class="d-flex justify-content-start">
                                            <div class="mr-2">
                                                ...
                                                <h2 class="text-bold-400">
                                                    ...
                                                    <span class="text-success"><?php echo e($data6['data'][1]); ?></span>
                                                </h2>
                                            </div>
                                            <div>
                                                ...
                                                <h2 class="text-bold-400">
                                                    <sup class="font-medium-1">$</sup>
                                                    <span><?php echo e($data6['data'][0]); ?></span>
                                                </h2>
                                            </div>
                                    ...
                                    <div class="card-body px-0 pb-0">
                                        ...
                                        <div class="row text-center mx-0">
                                            <div
                                                ...
                                                <p class="font-large-1 text-bold-700"><?php echo e($data7['data'][0]); ?></p>
                                            </div>
                                            <div class="col-6 border-top d-flex align-items-between flex-column py-1">
                                                <p class="mb-50">In Progress</p>
                                                <p class="font-large-1 text-bold-700">
                                                    <?php echo e($data7['goal'][0]-$data7['data'][0]); ?></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
</html><?php /**PATH C:\xampp\htdocs\dzautosql\resources\views/market.blade.php ENDPATH**/ ?>