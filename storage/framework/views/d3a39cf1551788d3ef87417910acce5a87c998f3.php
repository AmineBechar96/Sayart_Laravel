                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#" data-toggle="dropdown" data-i18n="Cards"><i class="feather icon-credit-card"></i>Cards</a>
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="active" data-menu=""><a class="dropdown-item" href="card-advance.html" data-toggle="dropdown" data-i18n="Advance"><i class="feather icon-circle"></i>Advance</a>
                                    </li>
                    ...
                    <div class="row match-height">
                        ...
                        <div class="col-xl-4 col-md-6 col-sm-12 profile-card-3">
                            <div class="card">
                                <div class="card-header mx-auto">
                                    <div class="avatar avatar-xl">
                                        <img class="img-fluid" src="../../../app-assets/images/portrait/small/avatar-s-1.jpg" alt="img placeholder">
                                    </div>
                                </div>
                                <div class="card-content">
                                    <div class="card-body text-center">
                                        ...
                                        <div class="progress progress-bar-primary box-shadow-6">
                                            <div class="progress-bar" role="progressbar" aria-valuenow="75" aria-valuemin="75" aria-valuemax="100" style="width:75%" aria-describedby="example-caption-3"></div>
                                        </div>
                                        <div class="card-btns d-flex justify-content-between">
                                            <button class="btn gradient-light-primary">Follow</button>
                                            <button class="btn btn-outline-primary">Message</button>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="card overlay-img-card text-white">
                                <img src="../../../app-assets/images/pages/card-image-6.jpg" class="card-img" alt="card-img-6">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="card overlay-img-card text-white">
                                <img src="../../../app-assets/images/pages/card-image-5.jpg" class="card-img" alt="card-img-6">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <img class="img-fluid" src="../../../app-assets/images/pages/content-img-4.jpg" alt="img placeholder">
                        ...
                        <div class="col-lg-8 col-sm-12">
                            <div class="card overflow-hidden">
                                <div class="embed-responsive embed-responsive-16by9">
                                    <iframe class="embed-responsive-item" width="560" height="315" src="https://www.youtube.com/embed/mcixldqDIEQ" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                </div>
                            </div>
                        </div>
                    </div>
...
</html><?php /**PATH C:\xampp\htdocs\dzautotrader\resources\views/card-advance.blade.php ENDPATH**/ ?>