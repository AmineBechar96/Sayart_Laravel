...
<head>
    ...
    <title>Analytics Cards - Vuexy - Bootstrap HTML admin template</title>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#" data-toggle="dropdown" data-i18n="Cards"><i class="feather icon-credit-card"></i>Cards</a>
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="active" data-menu=""><a class="dropdown-item" href="card-analytics.html" data-toggle="dropdown" data-i18n="Analytics"><i class="feather icon-circle"></i>Analytics</a>
                                    </li>
...
</html><?php /**PATH C:\xampp\htdocs\dzautotrader\resources\views/card-analytics.blade.php ENDPATH**/ ?>