...
<body
    ...
    <div class="app-content content">
        ...
        <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('recovery-truck')->html();
} elseif ($_instance->childHasBeenRendered('wHiWkyH')) {
    $componentId = $_instance->getRenderedChildComponentId('wHiWkyH');
    $componentTag = $_instance->getRenderedChildComponentTagName('wHiWkyH');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('wHiWkyH');
} else {
    $response = \Livewire\Livewire::mount('recovery-truck');
    $html = $response->html();
    $_instance->logRenderedChild('wHiWkyH', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</html><?php /**PATH C:\xampp\htdocs\dzautosql\resources\views/recovery-truck.blade.php ENDPATH**/ ?>