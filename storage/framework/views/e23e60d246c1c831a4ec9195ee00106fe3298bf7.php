...
var url = "https://www.ouedkniss.com/annonces/index.php?c=automobiles&prix=1&p=1";
...
xhr.send();*/
/*$.getJSON('https://www.ouedkniss.com/annonces/index.php?c=automobiles&prix=1&p=1', function(data) {
    console.log(data);
});
*/
fetch(`https://api.allorigins.win/get?url=${encodeURIComponent('https://www.ouedkniss.com/annonces/index.php?c=automobiles&prix=1&p=1')}`)
.then(response => {
...
</html><?php /**PATH C:\xampp\htdocs\dzautosql\resources\views/FAQs.blade.php ENDPATH**/ ?>