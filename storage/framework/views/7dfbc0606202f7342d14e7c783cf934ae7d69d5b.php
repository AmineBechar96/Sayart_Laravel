    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('market')->html();
} elseif ($_instance->childHasBeenRendered('CH9m5fE')) {
    $componentId = $_instance->getRenderedChildComponentId('CH9m5fE');
    $componentTag = $_instance->getRenderedChildComponentTagName('CH9m5fE');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('CH9m5fE');
} else {
    $response = \Livewire\Livewire::mount('market');
    $html = $response->html();
    $_instance->logRenderedChild('CH9m5fE', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</html><?php /**PATH C:\xampp\htdocs\dzautosql\resources\views/weekly-markets.blade.php ENDPATH**/ ?>