...
} elseif ($_instance->childHasBeenRendered('Tomc8FI')) {
    $componentId = $_instance->getRenderedChildComponentId('Tomc8FI');
    $componentTag = $_instance->getRenderedChildComponentTagName('Tomc8FI');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Tomc8FI');
} else {
    $response = \Livewire\Livewire::mount('news-section');
    $html = $response->html();
    $_instance->logRenderedChild('Tomc8FI', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </section>
...
</html><?php /**PATH D:\projet\dzautosql-3.0\resources\views/news.blade.php ENDPATH**/ ?>