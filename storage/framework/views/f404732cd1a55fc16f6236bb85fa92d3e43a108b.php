...
} elseif ($_instance->childHasBeenRendered('ijOik2H')) {
    $componentId = $_instance->getRenderedChildComponentId('ijOik2H');
    $componentTag = $_instance->getRenderedChildComponentTagName('ijOik2H');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ijOik2H');
} else {
    $response = \Livewire\Livewire::mount('detached-pieces');
    $html = $response->html();
    $_instance->logRenderedChild('ijOik2H', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</html><?php /**PATH D:\projet\dzautosql-3.0\resources\views/detached-pieces-stores.blade.php ENDPATH**/ ?>