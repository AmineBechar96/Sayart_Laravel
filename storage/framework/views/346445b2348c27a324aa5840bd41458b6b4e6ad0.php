...
} elseif ($_instance->childHasBeenRendered('qzROQuh')) {
    $componentId = $_instance->getRenderedChildComponentId('qzROQuh');
    $componentTag = $_instance->getRenderedChildComponentTagName('qzROQuh');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('qzROQuh');
} else {
    $response = \Livewire\Livewire::mount('general-mech');
    $html = $response->html();
    $_instance->logRenderedChild('qzROQuh', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</html><?php /**PATH D:\projet\dzautosql-3.0\resources\views/general-mechanic.blade.php ENDPATH**/ ?>