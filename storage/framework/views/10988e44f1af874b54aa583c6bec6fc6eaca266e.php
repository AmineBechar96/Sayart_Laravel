    ...
    <div class="header-navbar navbar-expand-sm navbar navbar-horizontal floating-nav navbar-light navbar-without-dd-arrow navbar-shadow menu-border"
        ...
        <div class="navbar-container main-menu-content" data-menu="menu-container">
            ...
            <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
                <li><a class="nav-link" href="<?php echo e(url('home')); ?>"><i class="feather icon-home"></i><span
                            data-i18n="Dashboard">Accueil</span></a>

                </li>
                <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#"
                        data-toggle="dropdown"><i class="feather icon-box"></i><span data-i18n="Apps">Valeur</span></a>
                    <ul class="dropdown-menu">
                        <li data-menu=""><a class="dropdown-item" href="<?php echo e(url('home')); ?>" data-toggle="dropdown"
                                data-i18n="Email"><i class="feather icon-search"></i>Estimation</a>
                        </li>
                        <li data-menu=""><a class="dropdown-item" href="<?php echo e(url('advanced')); ?>" data-toggle="dropdown"
                                data-i18n="Chat"><i class="feather icon-slack"></i>Estimation Avancée</a>
                        </li>
                ...
                <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#"
                    ...
                    <ul class="dropdown-menu">
                        <li data-menu=""><a class="dropdown-item" href="<?php echo e(url('budget')); ?>" data-toggle="dropdown"
                ...
                <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#"
                    ...
                    <ul class="dropdown-menu">
                        <li data-menu="dropdown-submenu"><a class="dropdown-item " href="<?php echo e(url('check')); ?>"
                                data-toggle="dropdown" data-i18n="Form Elements"><i
                                    class="feather icon-activity"></i>Verfication</a>
                            <!--ul class="dropdown-menu">
                ...
                <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#"
                    ...
                    <ul class="dropdown-menu">
                        <li data-menu=""><a class="dropdown-item" href="<?php echo e(url('weekly-markets')); ?>"
                                data-toggle="dropdown" data-i18n="Profile"><i class="feather icon-map"></i>Marchés
                                Hebdomadaires</a>
                        </li>
                        <li data-menu=""><a class="dropdown-item" href="<?php echo e(url('sell-points')); ?>" data-toggle="dropdown"
                ...
                <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#"
                    ...
                    <ul class="dropdown-menu">
                        <li data-menu="dropdown-submenu"><a class="dropdown-item" href="<?php echo e(url('features')); ?>"
                                data-toggle="dropdown" data-i18n="Charts"><i
                                    class="feather icon-shield"></i>Caractéristiques</a>

                        </li>
                        <li data-menu=""><a class="dropdown-item" href="<?php echo e(url('best')); ?>" data-toggle="dropdown"
                                data-i18n="Google Maps"><i class="feather icon-trending-up"></i>Meilleure</a>
                        </li>
                        <li data-menu=""><a class="dropdown-item" href="<?php echo e(url('market')); ?>" data-toggle="dropdown"
                ...
                <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#"
                        data-toggle="dropdown"><i class="feather icon-package"></i><span
                            data-i18n="Charts &amp; Maps">Autres</span></a>
                    <ul class="dropdown-menu">
                        <li data-menu="dropdown-submenu"><a class="dropdown-item" href="<?php echo e(url('general-mechanic')); ?>"
                                data-toggle="dropdown" data-i18n="Charts"><i
                                    class="feather icon-settings"></i>Mechaniciens</a>

                        </li>
                        <li data-menu=""><a class="dropdown-item" href="<?php echo e(url('detached-pieces-stores')); ?>"
                ...
                <li data-menu="dropdown"><a class="nav-link" href="<?php echo e(url('news')); ?>"><i
                            class="feather icon-paper-clip"></i><span data-i18n="Others">News</span></a>
...
<!-- END: Main Menu--><?php /**PATH D:\projet\dzautosql-3.0\resources\views/layouts/horizontal-menu.blade.php ENDPATH**/ ?>