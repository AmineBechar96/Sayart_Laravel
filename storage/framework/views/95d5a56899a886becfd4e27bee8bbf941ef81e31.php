...
} elseif ($_instance->childHasBeenRendered('KAhBEIy')) {
    $componentId = $_instance->getRenderedChildComponentId('KAhBEIy');
    $componentTag = $_instance->getRenderedChildComponentTagName('KAhBEIy');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('KAhBEIy');
} else {
    $response = \Livewire\Livewire::mount('market');
    $html = $response->html();
    $_instance->logRenderedChild('KAhBEIy', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</html><?php /**PATH D:\projet\dzautosql-3.0\resources\views/weekly-markets.blade.php ENDPATH**/ ?>