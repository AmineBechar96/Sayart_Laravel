...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../../app-assets/css/plugins/extensions/context-menu.css">
    <!-- END: Page CSS-->
...
<body class="horizontal-layout horizontal-menu 2-columns  navbar-floating footer-static  " data-open="hover" data-menu="horizontal-menu" data-col="2-columns">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#" data-toggle="dropdown" data-i18n="Extensions"><i class="feather icon-box"></i>Extensions</a>
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="active" data-menu=""><a class="dropdown-item" href="ext-component-context-menu.html" data-toggle="dropdown" data-i18n="Context Menu"><i class="feather icon-circle"></i>Context Menu</a>
                                    </li>
    ...
    <script src="../../../app-assets/vendors/js/extensions/jquery.contextMenu.min.js"></script>
    <script src="../../../app-assets/vendors/js/extensions/jquery.ui.position.min.js"></script>
    ...
    <!-- BEGIN: Page JS-->
    <script src="../../../app-assets/js/scripts/extensions/context-menu.js"></script>
    <!-- END: Page JS-->

</body>
<!-- END: Body-->

</html><?php /**PATH C:\xampp\htdocs\dzautosql\resources\views/ext-component-context-menu.blade.php ENDPATH**/ ?>