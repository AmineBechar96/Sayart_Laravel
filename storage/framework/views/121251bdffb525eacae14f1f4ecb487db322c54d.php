...
<body
    ...
    <div class="app-content content">
        ...
        <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('detached-pieces')->html();
} elseif ($_instance->childHasBeenRendered('9UK3EFm')) {
    $componentId = $_instance->getRenderedChildComponentId('9UK3EFm');
    $componentTag = $_instance->getRenderedChildComponentTagName('9UK3EFm');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('9UK3EFm');
} else {
    $response = \Livewire\Livewire::mount('detached-pieces');
    $html = $response->html();
    $_instance->logRenderedChild('9UK3EFm', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</html><?php /**PATH C:\xampp\htdocs\dzautosql\resources\views/detached-pieces-stores.blade.php ENDPATH**/ ?>