...
<head>
    ...
    <title>agGrid Table - Vuexy - Bootstrap HTML admin template</title>
...
<body class="horizontal-layout horizontal-menu 2-columns  navbar-floating footer-static  " data-open="hover" data-menu="horizontal-menu" data-col="2-columns">
                ...
                <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
                    ...
                    <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown"><i class="feather icon-edit-2"></i><span data-i18n="Forms &amp; Tables">Forms &amp; Tables</span></a>
                        <ul class="dropdown-menu">
                            ...
                            <li class="active" data-menu=""><a class="dropdown-item" href="table-ag-grid.html" data-toggle="dropdown" data-i18n="agGrid Table"><i class="feather icon-grid"></i>agGrid Table</a>
                            </li>
                        </ul>
                    </li>
    ...
    <!-- BEGIN: Page JS-->
    <script src="../../../app-assets/js/scripts/ag-grid/ag-grid.js"></script>
    <!-- END: Page JS-->

</body>
<!-- END: Body-->

</html><?php /**PATH C:\xampp\htdocs\dzautotrader\resources\views/table-ag-grid.blade.php ENDPATH**/ ?>