...
<head>
    ...
    <title>Category - Vuexy - Bootstrap HTML admin template</title>
                ...
                <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
                    ...
                    <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown"><i class="feather icon-file"></i><span data-i18n="Pages">Pages</span></a>
                        <ul class="dropdown-menu">
                            ...
                            <li class="active" data-menu=""><a class="dropdown-item" href="page-knowledge-base.html" data-toggle="dropdown" data-i18n="Knowledge Base"><i class="feather icon-info"></i>Knowledge Base</a>
                            </li>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                ...
                <section id="knowledge-base-category mb-0">
                    <div class="row">
                        <div class="col-12">
                            <p>petiole antimasquer nonenduring hoofish unbed anergic sweetwood ailsyte.</p>
                        </div>
                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="page-kb-question.html" class="knowledge-base-category">
                                        <ul class="list-group list-group-flush mt-1">
                                            ...
                                            <li class="list-group-item">Marzipan chocolate gummi bears bonbon powder?</li>
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="page-kb-question.html" class="knowledge-base-category">
                                        <ul class="list-group list-group-flush mt-1">
                                            ...
                                            <li class="list-group-item">Fruitcake bonbon dessert gingerbread powder?</li>
                                        </ul>
                                    </a>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="page-kb-question.html" class="knowledge-base-category">
                                        <ul class="list-group list-group-flush mt-1">
                                            ...
                                            <li class="list-group-item">Brownie dessert gummies. Tiramisu bear claw apple?</li>
                                        </ul>
                                    </a>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="page-kb-question.html" class="knowledge-base-category">
                                        <ul class="list-group list-group-flush mt-1">
                                            ...
                                            <li class="list-group-item">Lemon drops gingerbread chupa chups tiramisu?</li>
                                        </ul>
                                    </a>
                                </div>
                            </div>
...
</html><?php /**PATH C:\xampp\htdocs\dzautotrader\resources\views/page-kb-category.blade.php ENDPATH**/ ?>