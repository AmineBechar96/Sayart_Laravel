                ...
                <div class="card ecommerce-card">
                    <div class="card-content" id="prod1">
                        <div class="item-img text-center">
                            ...
                            <?php else: ?>
                            <a href="<?php echo e($agency->type); ?>/agency-details/<?php echo e($agency->ID); ?>"> <img class="img-fluid"
                            ...
                            <ul class="chat-users-list-wrapper media-list">
                                ...
                                <li class="list-group-item text-center mr-3">
                                    ...
                                    <img class="img-fluid cursor-pointer" id="mod"
                                        src="../../../app-assets/images/brands/<?php echo e(strtolower($model->Maison)); ?>.png"
                                        alt="<?php echo e($model->Maison); ?>">
                    ...
                    $('#selectedCommune').on('change', function (e) {
                        ...
                        $('#mod').on('click', function (e) {
                           ...
                           // selectedModel='["'+selectedModel+'",'+'"'+selectedModel+'"]'; 
                            ...
                            window.livewire.find('<?php echo e($_instance->id); ?>').set('modell',selectedModel);
...
<?php $__env->stopPush(); ?><?php /**PATH C:\xampp\htdocs\dzautosql\resources\views/livewire/sell-point.blade.php ENDPATH**/ ?>